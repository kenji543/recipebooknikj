...
export default function RecipeForm() {
  ...
  return (
    ...
    >
      ...
      <div className="bg-white rounded-[40px] p-8 md:p-16 shadow-sm border border-natural-border">
        <header className="mb-12 text-center">
          <div className="w-16 h-16 bg-natural-accent/5 rounded-full flex items-center justify-center mx-auto mb-6">
            <Utensils className="text-natural-accent" size={32} />
          </div>
          <h2 className="text-4xl md:text-5xl font-serif italic text-natural-text leading-tight">Create Signature Dish</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-3">
              <label className="text-[10px] uppercase tracking-[0.2em] text-natural-accent font-bold flex items-center gap-2 px-1">
                <Clock size={12} /> Preparation Time (Minutes)
              </label>
              <input 
                required
                type="number"
          ...
          <div className="space-y-3">
            ...
            <div className="relative group">
              <label className="cursor-pointer">
                ...
                />
                <div className="w-full h-80 bg-natural-bg border-2 border-dashed border-natural-border rounded-[32px] flex flex-col items-center justify-center text-natural-muted hover:bg-natural-accent/5 hover:border-natural-accent/40 transition-all overflow-hidden relative">
                  {photoPreview ? (
                  ...
                  >
                    ...
                    {ingredients.length > 1 && (
                      <button 
                        ...
                        className="p-3 text-red-300 hover:text-red-500 hover:bg-red-50 transition-colors rounded-xl"
                      >
                        <Trash2 size={18} />
                      </button>
                    )}
          ...
          <div className="pt-8">
            <button 
              ...
              className="w-full bg-natural-accent hover:bg-natural-accent/90 text-white py-6 rounded-full font-bold shadow-lg shadow-natural-accent/20 flex items-center justify-center gap-3 transition-all transform active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed text-lg uppercase tracking-widest"
            >
              {isSubmitting ? (
                ...
                <>
                  <Save size={20} />
                  <span>Finalize & Store Recipe</span>
                </>
              )}
            </button>
          </div>
